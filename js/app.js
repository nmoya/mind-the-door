...
window.onload = function () {
    ...
    document.getElementById("btn-lock-door").addEventListener("touchend", lockthedoor);
    ...
    document.getElementById("btn-come-back-home").addEventListener("touchend", backathome);
